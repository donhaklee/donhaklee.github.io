...
![Random](https://github.com/donhaklee/donhaklee.github.io/blob/9333fcff6e6a6e4dfee36ed2756fc2841cf6e3ac/images/XOR.PNG)<br><br>

멀티레이어로 해결해야하며 각각의 게이터는 classification으로 구성됨<br>
이전 Gate 모든 출력은 (previous output) 다음 Gate 입력 (next input)으로 들어감<br>

=> 신경망(Neural Network) 기반의 딥러닝 핵심 아이디어!!<br>
신경망 링크 : https://github.com/donhaklee/donhaklee.github.io/blob/master/_posts/2021-11-19-DeepLearning.md
